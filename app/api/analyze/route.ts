...
export async function POST(request: Request) {
  try {
    ...
    const analysisRecord = {
      ...
      prob_local: Number(parsed.prob_local || parsed.probabilities?.home_win || 0),
      prob_empate: Number(parsed.prob_empate || parsed.probabilities?.draw || 0),
      prob_visitante: Number(parsed.prob_visitante || parsed.probabilities?.away_win || 0),
      score_1: parsed.score_1,
      prob_1: Number(parsed.prob_1 || 0),
      score_2: parsed.score_2,
      prob_2: Number(parsed.prob_2 || 0),
